...
def main():
    ...
    goal = (
        "Create a plan to analyze an image of a Martian landscape and "
        "reason about potential water sources."
    )
    ...
    root = FractalNode(goal=goal, llm=llm, memory=memory, max_depth=2, task_type="reasoning")
